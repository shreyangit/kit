...
export function buildContextMenus(): void {
  // ── Images ──────────────────────────────────────────────────────────────
  chrome.contextMenus.create({ id: 'kit-img', title: '🛠️ kit tools', contexts: ['image'] })
  chrome.contextMenus.create({ id: 'img-remove-bg', parentId: 'kit-img', title: '✂️ Remove Background',     contexts: ['image'] })
  ...
  // ── Text Selection ───────────────────────────────────────────────────────
  chrome.contextMenus.create({ id: 'kit-text', title: '🛠️ kit tools', contexts: ['selection'] })
  ...
  chrome.contextMenus.create({ id: 'text-hash',       parentId: 'text-sub-encode', title: '#️⃣ Generate Hash (SHA/MD5)', contexts: ['selection'] })
  ...
  // ── Links ────────────────────────────────────────────────────────────────
  chrome.contextMenus.create({ id: 'kit-link', title: '🛠️ kit tools', contexts: ['link'] })
  chrome.contextMenus.create({ id: 'link-qr',       parentId: 'kit-link', title: '📱 Generate QR Code',           contexts: ['link'] })
  chrome.contextMenus.create({ id: 'link-og',       parentId: 'kit-link', title: '👁️ Preview Open Graph Card',    contexts: ['link'] })
  ...
  // ── Page ─────────────────────────────────────────────────────────────────
  chrome.contextMenus.create({ id: 'kit-page', title: '🛠️ kit tools', contexts: ['page'] })
  chrome.contextMenus.create({ id: 'page-qr',   parentId: 'kit-page', title: '📱 QR Code for this Page',          contexts: ['page'] })
  chrome.contextMenus.create({ id: 'page-og',   parentId: 'kit-page', title: '👁️ Preview Social Sharing Card',    contexts: ['page'] })
  chrome.contextMenus.create({ id: 'page-meta', parentId: 'kit-page', title: '🏷️ Inspect Meta Tags',              contexts: ['page'] })

  // ── Video ────────────────────────────────────────────────────────────────
  chrome.contextMenus.create({ id: 'kit-video', title: '🛠️ kit tools', contexts: ['video'] })
  chrome.contextMenus.create({ id: 'video-gif', parentId: 'kit-video', title: '🎞️ Convert to GIF',                contexts: ['video'] })
}
