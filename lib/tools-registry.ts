...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Resize by pixels or percentage, crop with visual drag handles.",
    category: "image",
    icon: "Crop",
    tags: ["resize", "crop", "image", "dimensions", "aspect ratio"],
  },
  {
    id: "pdf-to-image",
    name: "PDF to Image",
  ...
  },
  {
    ...
    description: "Generate custom QR codes for URLs, text, email, WiFi, and vCards.",
    category: "productivity",
    icon: "QrCode",
    tags: ["qr", "qrcode", "generate", "url", "text", "wifi", "vcard"],
  },
  {
    id: "unit-converter",
    name: "Unit Converter",
    description: "Length, weight, temperature, area, volume, speed, data, and more.",
    category: "productivity",
    icon: "ArrowLeftRight",
    tags: ["unit", "convert", "length", "weight", "temperature", "area", "speed"],
  },
  {
    id: "color-converter",
  ...
  },
  {
    ...
    description: "Extract dominant colors from any image with HEX and RGB values.",
    category: "design",
    icon: "Palette",
  ...
  },
  {
    id: "diff-checker",
    name: "Diff Checker",
    description: "Compare two texts side-by-side with word, line, or character diffs.",
    category: "text-code",
    icon: "GitCompare",
